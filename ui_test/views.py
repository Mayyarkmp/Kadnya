...
def home(request):
    return render(request, "ui_test/home.html")


def get_user_busy_time(request):
    return render(request, "ui_test/Calendar/get_user_busy_time.html")


def get_scheduled_events(request):
    return render(request, "ui_test/Calendar/get_scheduled_events.html")


def get_user_scheduled_events_invitees(request):
    return render(request, "ui_test/Calendar/user_scheduled_events_invitees.html")


def get_scheduled_event_details(request):
    return render(request, "ui_test/Calendar/scheduled_event_details.html")

def schedule_event(request):
    return render(request, "ui_test/Calendar/schedule_event.html")


def calendar_options(request):
    return render(request, "ui_test/Calendar/calendar_options.html")
